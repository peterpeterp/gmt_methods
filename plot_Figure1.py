...
for av_style in ['year','20year']:
	for preind_name in ['1861-1880','1850-1900']:
		...
		gmt_qu=da.read_nc('data/gmt_quantiles_'+av_style+'_'+preind_name+'.nc')['gmt_qu']
		...
		plt.tight_layout()
		plt.savefig('plots/FIG1_'+scenario+'_qu_'+av_style+'_'+preind_name+'.png')
		plt.savefig('plots/FIG1_'+scenario+'_qu_'+av_style+'_'+preind_name+'.pdf')
