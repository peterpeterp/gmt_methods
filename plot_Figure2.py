...
slr=pd.read_csv('data/slr_2100_temperature_levels_1p5_1p68_ref1986_2005.csv')
...
plot_dict={
	...
	'gmt_millar':{'wlvl':1.68,'name':'1.68_ref','light_color':'cornflowerblue','color':sns.color_palette()[0],'longname':'$\mathregular{GMT_{M17}}$','pos':1,'lsty':'-'},
...
gmt_millar_txx=all_cmip5._distributions['global']['pdf']['1.68_ref']
